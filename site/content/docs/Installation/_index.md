...
You can also install Kopia CLI with `winget` that comes preinstalled with Windows 11 (21H2 and later).
...
You can also install `KopiaUI` with `winget` that comes preinstalled with Windows 11 (21H2 and later).
