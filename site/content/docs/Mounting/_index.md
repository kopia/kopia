...
On macOS, the recommended option is to use `kopia mount --webdav` to use a WebDAV-based mount. This does not require any
...
its kernel backend. Refer to the [macFUSE getting started
