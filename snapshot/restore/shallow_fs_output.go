...
func (o *ShallowFilesystemOutput) WriteFile(ctx context.Context, relativePath string, f fs.File, ensureFileIsWrittenAtomic bool) error {
	...
	if de.FileSize < int64(o.MinSizeForPlaceholder) {
		return o.FilesystemOutput.WriteFile(ctx, relativePath, f, ensureFileIsWrittenAtomic)
	}
