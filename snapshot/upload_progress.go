...
type UploadProgress interface {
	Progress(path string, numFiles int, pathCompleted, pathTotal int64, stats *Stats)
	UploadFinished()
}
...
func (p *nullUploadProgress) Progress(path string, numFiles int, pathCompleted, pathTotal int64, stats *Stats) {
}
